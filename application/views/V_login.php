...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url('assets/temp/AdminLTE-2.4.2/plugins/iCheck/square/blue.css')?>">
    <!-- Theme style -->
...
<!-- Bootstrap 3.3.7 -->
<script src="<?php echo base_url('assets/temp/AdminLTE-2.4.2/bower_components/bootstrap/dist/js/bootstrap.min.js')?>"></script>
<!-- iCheck -->
<script src="<?php echo base_url('assets/temp/AdminLTE-2.4.2/plugins/iCheck/icheck.min.js')?>"></script>
<script>
  $(function () {
    $('input').iCheck({
